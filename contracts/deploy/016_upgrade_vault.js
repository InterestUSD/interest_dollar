...
const { isMainnet, isAlfajores, isFork } = require("../test/helpers.js");
...
const upgradeVaultCoreAndAdmin = async ({ getNamedAccounts }) => {
  console.log("Running 016_vault_upgrade deployment...");
  ...
  console.log("016_vault_upgrade complete");

  return true;
};

upgradeVaultCoreAndAdmin.id = "016_upgrade_vault";
upgradeVaultCoreAndAdmin.dependencies = ["015_flipper"];
upgradeVaultCoreAndAdmin.skip = () => !(isMainnet || isAlfajores || isFork);
